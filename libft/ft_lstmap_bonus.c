...
/*   Updated: 2024/09/13 16:36:19 by fghysbre         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

t_list	*ft_lstmap(t_prog *prog, t_list *lst,
	void *(*f)(void *), void (*del)(t_prog *, void *))
{
	t_list	*tmp;
	t_list	*lst_ptr;
	void	*ret;
	...
	while (lst)
	{
		...
		{
			free(ret);
			return (ft_lstclear(prog, &lst_ptr, del), (void *)0);
		}
