...
/*   Updated: 2024/10/09 23:10:32 by fghysbre         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				ft_lstdelone(t_prog *prog, t_list *lst, void (*del)
						(t_prog *prog, void *));
void				ft_lstclear(t_prog *prog, t_list **lst, void (*del)
						(t_prog *prog, void *));
